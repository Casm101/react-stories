    ...
    return (
      <main>
        <ReactStory
          ...
          watermark={{
            image:
              'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fpngimg.com%2Fuploads%2Fgithub%2Fgithub_PNG80.png&f=1&nofb=1&ipt=7b2e28bc05267cd350f52030c5acc05e0892fd3899074eb70b9f4fe0f1c29b2e&ipo=images',
          ...
          stories={[
            {
              ...
              story: () => (
                <div className="custom-story">
                  ...
                  <p className="title">
                    Stories to your heart's desire, from images and videos, to fully blown
                    React components.
                  </p>
                </div>
              )
    ...
    <>
      <main>
            ...
            stories={[
              {
                ...
                story: () => (
                  <div className="custom-story">
                    ...
                    <p className="subtitle">We support it all!</p>
                    <p className="title">
                      Stories to your heart's desire, from images and videos, to fully
                      blown React components.
                    </p>
                  </div>
                )
              },
        ...
        <section>
          <h1>React Stories</h1>
          <p>
            Simple and dynamic Meta (Instagram, Facebook, Whatsapp) inspired story
            component in React!
          </p>
          ...
          <div className="shield-container">
            <a href="https://github.com/Casm101/react-stories" target="_blank">
              <img
                ...
                src="https://img.shields.io/github/stars/Casm101/react-stories"
              />
            </a>
            <a
              href="https://www.npmjs.com/package/@casm101/react-stories"
              target="_blank"
            >
              <img
                className="shield"
                alt="npm"
                src="https://img.shields.io/npm/v/%40casm101%2Freact-stories"
              />
            </a>
          </div>

          <p>Get started now!</p>
          <code>npm i --save @casm101/react-stories</code>
          ...
          <div style={{ display: 'flex', gap: '4rem' }}>
            ...
            <div>
              ...
              <div>
                <img
                  src="./qr-code.svg"
                  alt="QRCode linking to github pages"
